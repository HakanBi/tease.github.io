...
*/
 ...
 SPDX-License-Identifier: Apache-2.0 */
  ...
  var hkb = function (a) {
    ...
    pkb = function (a, b, c) {
      var d = typeof c;
      "object" === d || "function" === d ? (a[b] = c) : mkb(a, b, c);
    },
    K5 = function () {
      var a = new kkb();
      a.__default = pkb;
    ...
    M5 = function (a, b) {
      ...
      b = L5(a, c, 1 === a.nodeType ? d || b : null);
    ...
    ukb = function () {
      for (var a = N5, b = O5 ? O5.nextSibling : N5.firstChild; null !== b; ) {
        var c = b.nextSibling;
        a.removeChild(b);
        P5.j.push(b);
        b = c;
    ...
    vkb = function (a, b) {
      O5 = O5 ? O5.nextSibling : N5.firstChild;
      if (Q5 && O5) L5(O5, a, b);
      else {
        var c;
        a: {
        ...
        c ||
          ("#text" === a
            ? ((a = S5.createTextNode("")), L5(a, "#text", null))
            : ((c = S5),
              (d = N5),
              "function" === typeof a
                ? (c = new a())
        ...
        if (a !== O5) {
          if (0 <= T5.indexOf(a))
            for (b = N5, c = a.nextSibling, d = O5; null !== d && d !== a; )
              (e = d.nextSibling), b.insertBefore(d, c), (d = e);
          else N5.insertBefore(a, O5);
          O5 = a;
        }
      }
    },
    ...
    zkb = function (a, b) {
      b = void 0 === b ? {} : b;
      var c = void 0 === b.matches ? tkb : b.matches,
        d = void 0 === b.d6 ? !1 : b.d6;
      return function (e, f, h) {
        ...
        U5 = [];
        O5 = null;
        var A = (N5 = e.parentNode),
          E,
          L = ykb.call(e);
        if (
          (E =
            11 === L.nodeType || 9 === L.nodeType ? L.activeElement : null) &&
          e.contains(E)
        ) {
          for (L = []; E !== A; )
            L.push(E), (E = E.parentNode || (A ? E.host : null));
          A = L;
        } else A = [];
        T5 = A;
        Q5 = d;
    ...
    Ckb = function (a) {
      for (var b in a) X5.attributes[b] = a[b](X5.attributes[b]);
    },
    Dkb = function () {
      jkb.apply(this, arguments);
    },
    Ekb = function (a) {
      return a.children;
    },
    Fkb = function (a) {
      var b;
      return void 0 !== (null == (b = a.prototype) ? void 0 : b.EA);
    },
    Ikb = function (a, b, c) {
      if (
        Object.hasOwnProperty.call(Gkb, a) &&
        ((a = Gkb[a]),
    ...
    Z5 = function (a) {
      if (void 0 !== a && null !== a)
        if (Array.isArray(a)) {
          ...
          var c = typeof a;
          if ("boolean" === c || "number" === c || "string" === c) Bkb(a);
          else {
            if ("string" === typeof a.type) {
              a.jq || wkb(a.type, a.props.idomKey);
              ...
              e = d;
              d = U5;
              f = f.j || (f.j = lkb(d.length));
              for (var h = !f.length || !1, l = 0; l < d.length; l += 2) {
                var m = d[l];
                if (h) f[l] = m;
                else if (f[l] !== m) break;
                var n = d[l + 1];
                if (h || f[l + 1] !== n) (f[l + 1] = n), Akb(c, m, n, e);
              }
              if (l < d.length || l < f.length) {
                for (l = h = l; l < f.length; l += 2) $5[f[l]] = f[l + 1];
                for (l = h; l < d.length; l += 2)
                  (h = d[l]),
                    (m = d[l + 1]),
                    $5[h] !== m && Akb(c, h, m, e),
                    (f[l] = h),
                    ...
                    delete $5[h];
                J5(f, d.length);
                for (b in $5) Akb(c, b, void 0, e), delete $5[b];
              }
              b = Rkb;
              Rkb = c = W5.length;
              for (e = b; e < c; e += 5)
                (0, W5[e])(W5[e + 1], W5[e + 2], W5[e + 3], W5[e + 4]);
              Rkb = b;
              J5(W5, b);
              J5(d, 0);
              (a.props.skip || a.props.skipchildren) && N5.hasChildNodes()
                ? (O5 = N5.lastChild)
                : Z5(a.children);
              b = xkb();
              a.jq && (a.jq = !1);
            ...
            if (a.type === Ekb) Z5(a.children);
            else {
              if ("function" === typeof a)
                throw Error("Can't use functions as TSX elements");
              X5.VY(a);
            }
          }
        }
    ...
    Tkb = function (a, b) {
      try {
        ...
        b = d;
        var c;
        null == (c = X5.XV) || c.call(X5, a, b);
      }
    },
    Ukb = function (a, b) {
      Fkb(a) ? (b = new a(b)) : ((b = new Dkb(b)), (b.C = a));
      b.G = a;
      b.j = { xX: b.state, p6: !1 };
      return b;
    },
    Vkb = function (a) {
      for (var b = 0; b < a.length; b++) {
        var c = void 0,
          ...
          h = a[b];
        h &&
          (null == (f = h.__ref) || null == (e = f.O9) || e.call(f),
          h.__instance &&
            ((e = h.__instance),
            null == (d = e.B) || null == (c = d.O9) || c.call(d),
            (e.el = null),
            delete h.__instance),
          Vkb(h.childNodes));
      }
          ...
          setTimeout(function () {
            ...
            for (var c = b.next(); !c.done; c = b.next()) {
              ...
              try {
                ...
                var d = (c = void 0);
                null == (d = (c = X5).XV) || d.call(c, "unknown", e);
              }
            }
          });
        });
    ...
    Lkb = function (a, b) {
      return Ykb.apply(null, [a, b].concat(g.pa(g.Ia.apply(2, arguments))));
    },
    Ykb = function (a, b) {
    ...
    Mkb = function () {
      return Lkb("ytp-pause-overlay", { class: "ytp-pause-overlay" });
    },
    Zkb = function (a) {
      g.X.call(this, { I: "div", T: "ytp-related-on-error-overlay" });
      var b = this;
      this.api = a;
      this.K = this.B = 0;
      this.G = new g.OJ(this);
      this.j = [];
      this.suggestionData = [];
      ...
      this.suggestions = new g.X({ I: "div", T: "ytp-suggestions" });
      g.H(this, this.suggestions);
      this.suggestions.Ka(this.element);
      g.H(this, this.previous);
      this.previous.Ka(this.element);
      this.previous.Ua("click", this.H0, this);
      g.H(this, this.qa);
      for (var c = { Cz: 0 }; 16 > c.Cz; c = { Cz: c.Cz }, c.Cz++) {
        var d = new g.X({
          I: "a",
          T: "ytp-suggestion-link",
          Z: { href: "{{link}}", target: a.ma, "aria-label": "{{aria_label}}" },
          Y: [
            {
              I: "div",
            ...
            { I: "div", T: "ytp-suggestion-author", Ba: "{{views_or_author}}" },
          ],
        });
        g.H(this, d);
        d.Ka(this.suggestions.element);
        var e = d.Ia("ytp-suggestion-link");
        g.yo(e, "transitionDelay", c.Cz / 20 + "s");
        this.G.V(
          e,
          "click",
          (function (f) {
            return function (h) {
              ...
              b.api.N(
                ...
                ? (b.api.ub(b.j[l].element),
                  (l = m.Vk()),
                  (m = {}),
                  g.qMa(b.api, m, "emb_rel_err"),
                  (l = g.gk(l, m)),
                  g.PS(l, b.api, h))
                : g.OS(h, b.api, b.W, n || void 0) &&
                  b.api.Co(m.videoId, n, m.playlistId);
            };
          })(c)
        );
        this.j.push(d);
      ...
      this.next.Ua("click", this.G0, this);
    ...
    alb = function (a) {
      ...
      g.nr(a.element, "ytp-scroll-min", 0 <= b);
      g.nr(a.element, "ytp-scroll-max", b <= c);
    },
    blb = function (a) {
      for (var b = 0; b < a.suggestionData.length; b++) {
        ...
        if (
          ...
          f = g.gk(f, g.WR(l, "emb_rel_err"));
        }
        d.element.style.display = "";
        l = d.Ia("ytp-suggestion-title");
        g.yr.test(c.title)
          ? (l.dir = "rtl")
          : g.Wcb.test(c.title) && (l.dir = "ltr");
        l = d.Ia("ytp-suggestion-author");
        g.yr.test(e) ? (l.dir = "rtl") : g.Wcb.test(e) && (l.dir = "ltr");
        d.update({
          views_or_author: e,
          duration: c.isLivePlayback
            ? "\u76f4\u64ad"
            : c.lengthSeconds
            ? g.fR(c.lengthSeconds)
            : "",
          link: f,
          hover_title: c.title,
          title: c.title,
        ...
        h.N("web_player_log_click_before_generating_ve_conversion_params") &&
          (a.api.Yf(d.element, d),
          (c = (c = c.sessionData) && c.itct) && a.api.dg(d.element, c));
      }
    ...
    a6 = function (a) {
      ...
      var c = a.X(),
        d = {
          ...
          Y: [
            { I: "path", Z: { d: "M0 0h24v24H0V0z", fill: "none" } },
            {
              I: "path",
              Z: {
      ...
      g.aM(c) &&
        (d = {
          ...
          Y: [
            {
              I: "g",
              Z: { "clip-path": "url(#clip0)", fill: "#fff" },
              Y: [
                {
                  I: "path",
                  Z: {
      ...
      c.C
        ...
        : ((c = g.tM(c)),
          ...
          (e["aria-label"] =
            "\u8bbf\u95ee YouTube \u4ee5\u641c\u7d22\u66f4\u591a\u89c6\u9891"));
      var h = new g.X({ I: "a", Na: f, Z: e, Y: [d] });
      h.Ka(this.element);
      ...
      g.H(this, h);
      a.X().C ||
        ((this.j = new Zkb(a)), this.j.Ka(this.element), g.H(this, this.j));
    ...
    glb = function (a, b) {
      var c = a.api.X(),
        d;
      b.reason &&
        (elb(b.reason) ? (d = g.QG(b.reason)) : (d = g.UT(g.PG(b.reason))),
        a.qe(d, "content"));
      var e;
      b.subreason &&
        (elb(b.subreason)
          ? (e = g.QG(b.subreason))
          : (e = g.UT(g.PG(b.subreason))),
        a.qe(e, "subreason"));
      if (b.proceedButton && b.proceedButton.buttonRenderer) {
        ...
        if (
          ...
          ((e = b.text.simpleText),
          (f.textContent = e),
          !flb(d, e) && (!c.C || c.embedsErrorLinks))
        ) {
          var h;
          c =
            null == (h = g.Q(null == b ? void 0 : b.navigationEndpoint, g.ON))
              ? void 0
              : h.url;
          var l;
          h =
            null == (l = g.Q(null == b ? void 0 : b.navigationEndpoint, g.ON))
              ? void 0
              : l.target;
          c &&
    ...
    b6 = function (a, b) {
        ...
        Y: [
          {
            ...
            Y: [
              ...
              { I: "div", T: "ytp-impression-link-logo", Y: [ikb()] },
            ],
          },
        ],
      });
      this.api = a;
      this.B = b;
      this.updateValue("target", a.X().ma);
      this.api.xb(this.element, this, 96714);
      this.V(this.api, "presentingplayerstatechange", this.aj);
    ...
    hlb = function (a) {
      ...
      return g.gk(a.api.getVideoUrl(), g.WR(b, "emb_imp_woyt"));
    },
    c6 = function (a) {
      g.X.call(this, {
        I: "div",
    ...
    klb = function (a) {
                            ...
                            Y: [
                              {
                                ...
                                Z: { height: "9", width: "4", x: "1", y: "7" },
                              },
                              {
                                I: "rect",
                                T: "ytp-equalizer-bar-middle",
                                Z: { height: "14", width: "4", x: "6", y: "2" },
                              },
                              {
                                I: "rect",
      ...
      this.C = new g.br(this.Z5, 4e3, this);
      this.B = !1;
      ...
      this.hide();
      g.iS(a.app) && (ilb(this), this.uK(), jlb(this));
    },
    jlb = function (a) {
    ...
    ilb = function (a) {
      a.watermark ||
        ...
        g.H(a, a.watermark),
        a.watermark.Ka(a.bottomButtons, 0),
        g.nr(a.watermark.element, "ytp-muted-autoplay-watermark", !0),
        (a.j = new g.WQ(a.watermark, 0, !0, 100)),
        g.H(a, a.j));
    },
    f6 = function (a, b) {
      g.X.call(this, {
      ...
      "0" === a.X().controlsType &&
        g.jr(a.getRootNode(), "ytp-pause-overlay-controls-hidden");
      g.H(this, this.C);
      g.H(this, this.D);
      var d = new g.X({
        I: "button",
        ...
        Z: {
          "aria-label": g.tS(this.api)
            ? "\u9690\u85cf\u66f4\u591a\u77ed\u89c6\u9891"
            : "\u9690\u85cf\u66f4\u591a\u89c6\u9891",
        },
        Y: [{ I: "div", T: "ytp-collapse-icon", Y: [g.XFa()] }],
      });
      g.H(this, d);
      d.Ka(this.element);
        ...
        Y: [
          {
            ...
            Y: [
              ...
              { I: "span", T: "ytp-countdown-timer-time", Ba: "{{duration}}" },
            ],
          },
        ],
      });
      ...
      b !== a.ma &&
        ...
        b &&
          ...
          g.tS(a.J) &&
            ...
            g.H(a, a.D),
            g.wS(a.J, a.D.element, 4),
            (a.B = new g.WQ(a.D, 1e3, !1, 100)),
            g.H(a, a.B),
            a.D.hide()),
          (a.G = new g.X({
            I: "div",
          ...
          a.J.N("embeds_web_enable_keto_pause_overlay")
            ? Okb(a.G.element)
            : ((a.C = new f6(a.J, b)), g.H(a, a.C), a.C.Ka(a.G.element)),
          g.wS(a.J, a.G.element, 4),
          plb(a, a.J.Kb())));
    },
    plb = function (a, b) {
      a.B &&
        ((!g.WO(b, 4) && !g.WO(b, 2)) || g.WO(b, 1024)
          ? a.B.hide()
          : a.B.show());
    },
    nlb = function (a) {
      var b = a.J;
      a = !!g.tS(b);
      g.nr(b.getRootNode(), "ytp-shorts-mode", a);
      if ((b = b.getVideoData())) b.tT = a;
    },
    i6 = function (a, b) {
      a = {
        ...
        embedUrl: g.cfa(a.J.X().loaderUrl),
        eventType: b,
        youtubeHost: g.ak(a.J.X().Oa) || "",
      };
      g.vC("embedsAdEvent", a);
    };
  var rlb = new Set(
  ...
  var nkb = Object.prototype.hasOwnProperty;
  kkb.prototype = Object.create(null);
  var Qkb = K5();
  var V5 = null;
  var ykb =
  ...
  var P5 = null,
    ...
    Q5 = !1,
    Nkb = (function (a) {
      return zkb(function (b, c, d) {
        N5 = O5 = b;
        O5 = null;
        c(d);
        (null != a && a.Veb) || (ukb(), (O5 = N5), (N5 = N5.parentNode));
        return b;
      }, a);
    })();
  var W5 = [],
  ...
  var X5 = {
    ...
    slb = [];
  g.x(Dkb, jkb);
  Dkb.prototype.EA = function (a) {
    return this.C(a);
  };
  var Pkb = Symbol("ATTR_TAG_VALUE");
  var Hkb = {
      align: 1,
      alt: 1,
    ...
    Gkb = {
      ...
      link: {
        href: [
          { Dd: 3, Yh: "rel", Ei: "alternate" },
          { Dd: 3, Yh: "rel", Ei: "author" },
          { Dd: 3, Yh: "rel", Ei: "bookmark" },
          { Dd: 3, Yh: "rel", Ei: "canonical" },
          { Dd: 3, Yh: "rel", Ei: "cite" },
          { Dd: 3, Yh: "rel", Ei: "help" },
          { Dd: 3, Yh: "rel", Ei: "icon" },
          { Dd: 3, Yh: "rel", Ei: "license" },
          { Dd: 3, Yh: "rel", Ei: "next" },
          { Dd: 3, Yh: "rel", Ei: "prefetch" },
          { Dd: 3, Yh: "rel", Ei: "dns-prefetch" },
          { Dd: 3, Yh: "rel", Ei: "prerender" },
          { Dd: 3, Yh: "rel", Ei: "preconnect" },
          { Dd: 3, Yh: "rel", Ei: "preload" },
          { Dd: 3, Yh: "rel", Ei: "prev" },
          { Dd: 3, Yh: "rel", Ei: "search" },
          { Dd: 3, Yh: "rel", Ei: "subresource" },
        ],
      },
      script: { defer: [{ Dd: 1 }] },
      source: { src: [{ Dd: 3 }] },
  ...
  var tlb = /^(?!javascript:)(?:[a-z0-9+.-]+:|[^&:\/?#]*(?:[\/?#]|$))/i,
    ...
    Jkb =
      ...
      (j6[3] = {
        zq: function (a, b, c) {
          return tlb.test(c) ? c : g.ke.toString();
        },
        Pt: function (a) {
      ...
      (j6[4] = {
        ...
        xs: function (a) {
          return g.Xd(a).toString();
        },
      }),
      (j6[5] = { zq: null, Pt: null, xs: null }),
      (j6[7] = { zq: null, Pt: null, xs: null }),
      (j6[8] = { zq: null, Pt: null, xs: null }),
      (j6[10] = {
        zq: null,
        Pt: function (a) {
          return a instanceof Y5 || a instanceof g.Qd;
        },
        xs: function (a) {
          if (a instanceof g.Qd) a = g.Rd(a);
          else {
            if (!(a instanceof Y5 && a.constructor === Y5))
  ...
  var ulb = K5(),
    ...
    k6 = {
      attributes:
        ((xlb.__default = function () {
          return function (a, b, c) {
            if (!1 === c && rlb.has(b)) mkb(a, b, null);
            else if ("el" === b) {
              b = c;
              if (b.Xcb) throw Error(ylb);
              var d;
              null == (d = b.V8) || d.call(b, a);
            } else
              "idomKey" !== b &&
                "skip" !== b &&
                "skipchildren" !== b &&
  ...
  slb.push(k6);
  k6.attributes && Ckb(k6.attributes);
  if (k6.B$) {
    var zlb = k6.B$,
      Alb;
    for (Alb in zlb);
  ...
  var ylb =
    "A reference returned by useRootElement was passed to theel prop of an element. Pass a reference returned by useElement.";
  var Wkb = [];
  var Blb = K5();
  X5.VY = function (a) {
    var b = a.type,
    ...
    if (Fkb(b) || X5.wC) {
      ...
      if (X5.wC) {
        var d;
        (d = a.props).idomKey || (d.idomKey = X5.G$(b));
      }
      if (!c && X5.wC) {
        if (((c = Ukb(b, a.props)), (d = Skb(c)))) {
          if ("function" === typeof d.type)
            throw Error(
              "Higher Order Components are not currently supported. All components  must return a single intrinsic element like <div> or <span>."
            );
          var e = Z5(d);
          if (!e)
            throw Error(
              "Function component did not return an intrinsic root element"
            );
          if (c.B) {
            if (d.props.el)
              throw Error(
                "Tried to place reference on an element already referenced with useRootElement"
              );
            var f, h;
            null == (h = (f = c.B).V8) || h.call(f, e);
          }
          b.q3 = e.tagName.toLowerCase();
          e.__instance = c;
          c.el = e;
        }
      } else {
        var l = wkb(c, a.props.idomKey);
        a.jq = !0;
        Tkb(c, function () {
          if (!l.__instance) {
            var m = Ukb(b, a.props);
          ...
          m.props = q;
          m.state = n;
          if ((m = Skb(m))) a && (m.jq = a.jq), Z5(m), a && (a.jq = m.jq);
        });
        a.jq && (xkb(), (a.jq = !1));
      }
    } else Z5(b(a.props));
  ...
  X5.wC = !0;
  X5.attributes = Blb;
  for (var Clb = g.v(slb), Dlb = Clb.next(); !Dlb.done; Dlb = Clb.next()) {
    var Elb = Dlb.value;
    Elb.attributes && Ckb(Elb.attributes);
  }
  (function () {
    var a = V5;
    V5 = function (b) {
  ...
  g.k.resize = function (a, b) {
    ...
    if (150 >= Math.min(a.width, a.height) || 0 === h || !c.Rd) this.hide();
    else {
      var l;
      if (e) {
        var m = (l = 28);
      ...
      b &&
        ...
        (m = a / l - this.B),
        (q = Math.floor(m / d)));
      50 > m || g.sS(this.api) ? this.hide() : this.show();
      for (b = 0; b < h; b++) {
        d = this.j[b];
  ...
  g.k.onVideoDataChange = function () {
    ...
    this.W = a.Gd ? !1 : b.D;
    a.suggestions
      ? (this.suggestionData = g.sp(a.suggestions, function (c) {
    ...
    a.Gd
      ? this.title.update({
          title: g.jP(
            "\u6765\u81ea\u201c$DNI_RELATED_CHANNEL\u201d\u9891\u9053\u7684\u66f4\u591a\u89c6\u9891",
            { DNI_RELATED_CHANNEL: a.author }
          ),
        })
      : this.title.update({ title: "\u66f4\u591a YouTube \u89c6\u9891" });
  };
  ...
  a6.prototype.show = function () {
    g.TT.prototype.show.call(this);
    dlb(this, this.api.qb().getPlayerSize());
  };
  a6.prototype.resize = function (a) {
    g.TT.prototype.resize.call(this, a);
    this.j &&
      (dlb(this, a),
      g.nr(
        this.element,
  ...
  g.x(b6, g.X);
  b6.prototype.aj = function () {
    this.api.Kb().isCued() || (this.hide(), this.api.Za(this.element, !1));
  };
  b6.prototype.j = function () {
    var a = this.api.getVideoData(),
      b = this.api.X(),
      c = this.api.getVideoData().Gd,
      d = b.Xd,
      e = !b.Rd,
      f = this.B.Ug(),
      h = g.aM(b);
    b = b.C;
    d || f || c || e || h || b || g.tS(this.api) || !a.videoId
      ? (this.hide(), this.api.Za(this.element, !1))
      : ((a = hlb(this)), this.updateValue("url", a), this.show());
  };
  ...
  b6.prototype.show = function () {
    this.api.Kb().isCued() &&
      (g.X.prototype.show.call(this),
      this.api.qj(this.element) && this.api.Za(this.element, !0));
  };
  g.x(c6, g.X);
  c6.prototype.aj = function () {
    var a = this.api.Kb();
    !this.api.Mh() || (g.WO(a, 2) && g.pS(this.api)) || g.WO(a, 64)
      ? (this.api.Za(this.j, !1),
  ...
  d6.prototype.C = function () {
    ...
    this.api.X().N("embeds_enable_muted_autoplay") &&
      b.mutedAutoplay &&
      (g.WO(a, 2) && !this.Gb
        ? (this.show(),
          this.j ||
            ((this.j = new g.RT(this.api)),
            g.H(this, this.j),
            this.j.Ka(this.D, 0),
            this.j.show()),
          (a = this.api.getVideoData()),
          this.updateValue("text", a.UZ),
          g.nr(this.element, "ytp-muted-autoplay-show-end-panel", !0),
  ...
  d6.prototype.onClick = function () {
    if (!this.B) {
      ...
      g.nr(this.api.getRootNode(), "ytp-muted-autoplay", !1);
      var a = this.api.getVideoData(),
  ...
  g.k.x_ = function () {
    var a = this.api.getVideoData(),
      b = this.api.getVideoData(1).Gd,
      c = this.api.X();
    b = c.Xd && !g.WO(this.state, 2) && !(b && c.qa);
    a.mutedAutoplay || g.xQ(this, b);
  ...
  g.k.onVideoDataChange = function () {
    var a = this.api.X();
    a.C && g.jr(this.element, "ytp-no-hover");
    this.api.getVideoData().videoId && !a.C
      ...
      : this.j &&
        (this.updateValue("url", null), this.Mc(this.j), (this.j = null));
  };
  g.k.onClick = function (a) {
    ...
    if (
      ...
      b = g.gk(b, g.WR(c, "emb_yt_watermark"));
    }
    g.PS(b, this.api, a);
    this.api.N("web_player_log_click_before_generating_ve_conversion_params") ||
      this.api.ub(this.element);
  ...
  g.k.uK = function () {
    ...
    !g.WO(a, 2)
      ? this.Gb ||
        (g.X.prototype.show.call(this), this.api.Za(this.element, this.Gb))
      : this.hide();
  };
  g.k.Z5 = function () {
    this.j && this.j.hide();
  ...
  f6.prototype.hide = function () {
    g.lr(this.api.getRootNode(), "ytp-expand-pause-overlay");
    g.X.prototype.hide.call(this);
  };
  f6.prototype.G = function () {
    this.B = !0;
    g.lr(this.api.getRootNode(), "ytp-expand-pause-overlay");
    g.tS(this.api) && this.api.Za(this.element, !1);
    this.expandButton.focus();
  };
  f6.prototype.K = function () {
    this.B = !1;
    g.jr(this.api.getRootNode(), "ytp-expand-pause-overlay");
    g.tS(this.api) && this.api.Za(this.element, !0);
    this.focus();
  };
  f6.prototype.Ta = function (a) {
    a = this.api.X().N("embeds_web_enable_pause_overlay_wn_update")
      ? this.api.Kb()
      : a.state;
    g.WO(a, 1) ||
      g.WO(a, 16) ||
      g.WO(a, 32) ||
      (!g.WO(a, 4) || g.WO(a, 2) || g.WO(a, 1024)
        ? (this.B || this.api.Za(this.element, !1), this.D.hide())
  ...
  g.k.create = function () {
    ...
    d && g.BH({ clientPlaybackNonce: d });
    qlb(this);
    a.N("embeds_enable_muted_autoplay") &&
      ((this.W = new klb(this.J)),
      g.H(this, this.W),
      g.wS(this.J, this.W.element, 4),
      (this.ra = new d6(this.J)),
      g.H(this, this.ra),
      g.wS(this.J, this.ra.element, 4));
    a.Xd &&
      ((this.watermark = new e6(this.J)),
      g.H(this, this.watermark),
      g.wS(this.J, this.watermark.element, 8));
    this.K = new b6(this.J, b);
    g.H(this, this.K);
    g.wS(this.J, this.K.element, 8);
    g.iS(this.J.app) && (this.onMutedAutoplayStarts(), this.K.hide());
    a.B &&
      ((this.qa = new c6(this.J)),
      g.H(this, this.qa),
      g.wS(this.J, this.qa.element, 4));
    this.j.V(this.J, "appresize", this.Lb);
    this.j.V(this.J, "presentingplayerstatechange", this.aj);
    this.j.V(this.J, "videodatachange", this.onVideoDataChange);
    this.j.V(this.J, "videoplayerreset", this.Hw);
    ...
    if ((this.S = g.tB(g.bM(a))))
      (this.countdownTimer = new g6(this.J)),
        g.H(this, this.countdownTimer),
        g.wS(this.J, this.countdownTimer.element, 4),
        this.countdownTimer.hide(),
        this.j.V(this.J, g.KG("embeds"), this.onCueRangeEnter),
        this.j.V(this.J, g.LG("embeds"), this.onCueRangeExit);
    this.wc(this.J.Kb());
  ...
  g.k.onCueRangeEnter = function (a) {
    "countdown timer" === a.getId() &&
      this.countdownTimer &&
      (this.countdownTimer.show(), mlb(this.countdownTimer));
  };
  ...
  g.k.wc = function (a) {
    g.WO(a, 128)
      ? (this.Gg ||
          ((this.Gg = new a6(this.J)),
          g.H(this, this.Gg),
          g.wS(this.J, this.Gg.element, 4)),
        this.Gg.B(a.eh),
        this.Gg.show(),
        g.jr(this.J.getRootNode(), "ytp-embed-error"))
      : this.Gg &&
        (this.Gg.dispose(),
        (this.Gg = null),
        g.lr(this.J.getRootNode(), "ytp-embed-error"));
    if (this.countdownTimer && this.countdownTimer.j)
      if (g.WO(a, 64)) this.countdownTimer.hide(), h6(this.countdownTimer);
      else if (g.AP(a)) {
        var b = this.countdownTimer;
        b.B || ((b.B = !0), (b.G = (0, g.aD)()));
      } else
        a.isPlaying() &&
          this.countdownTimer.B &&
          ((b = this.countdownTimer),
          b.B && ((b.D += (0, g.aD)() - b.G), (b.B = !1), llb(b)));
    plb(this, a);
  };
  g.k.onMutedAutoplayStarts = function () {
    this.J.getVideoData().mutedAutoplay &&
      this.W &&
      g.nr(this.J.getRootNode(), "ytp-muted-autoplay", !0);
  };
  g.k.onVideoDataChange = function (a, b) {
    var c = this.ED !== b.videoId;
    a = !c && "dataloaded" === a;
    var d = { isShortsModeEnabled: !!g.tS(this.J) };
    g.vC("embedsVideoDataDidChange", {
    ...
    c &&
      ...
      nlb(this),
      qlb(this));
    this.J.X().C && this.C && this.C.detach();
  };
